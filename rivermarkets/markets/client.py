...
class MarketsClient:
    ...
    def match_markets_batch(
        self,
        *,
        tickers: typing.Optional[typing.Sequence[str]] = OMIT,
        slugs: typing.Optional[typing.Sequence[str]] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
        ...
        Parameters
        ----------
        tickers : typing.Optional[typing.Sequence[str]]
            Exact Kalshi tickers to resolve (e.g. KXNBA-26-DET).

        slugs : typing.Optional[typing.Sequence[str]]
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(
                    MarketMatchBatchResponse,
                    parse_obj_as(
                        type_=MarketMatchBatchResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
            if _response.status_code == 422:
...
class AsyncMarketsClient:
    ...
    async def match_markets_batch(
        ...
        *,
        ...
        async def main() -> None:
            await client.markets.match_markets_batch()
